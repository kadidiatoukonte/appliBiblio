...
<nav class="w3-sidebar w3-collapse w3-white" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
		<a href="book.php" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Livres</a>
	...
	<div class="w3-container">
			...
			<div class="w3-container">
				...
				<div id="addUser" class="w3-modal">
					<div class="w3-modal-content">
						...
						<form class="w3-container w3-section" action="userDetail.php" method="post">
				...
				<div class="w3-container w3-row">
					...
					<a href="user.php" class="w3-button w3-black">Retour</a>
					<div class="w3-row">
						<p class="w3-col"><b>Nom :</b> <br></p>
						<p class="w3-col"><b>Prénom :</b> <br></p>
						<p class="w3-col"><b>Identifiant :</b> <br></p>
						<p class="w3-col"><b>Nombre d'emprunts :</b> <br></p>
						<p class="w3-col"><b>Livres empruntés :</b> <br></p>
				    </div>
				</div>
			</div>
		</div>
		<div class="w3-row">
			<div class=" w3-padding-16 w3-section w3-row">
				...
				<form class="w3-col m1 w3-margin-left" action="delete.php" method="post">
			...
			<div id="editUser" class="w3-modal">
				<div class="w3-modal-content">
					...
					<form class="w3-container w3-section" action="" method="post">
						<label for="last_name">Nom</label>
						<input id="last_name" class="w3-input w3-border w3-margin-bottom" type="text" name="lastName" value="" required>
						<label for="first_name">Prénom</label>
						<input id="first_name" class="w3-input w3-border w3-margin-bottom" type="text" name="firstName" value="" required>
